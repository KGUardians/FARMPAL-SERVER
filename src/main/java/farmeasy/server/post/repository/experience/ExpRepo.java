...
import static farmeasy.server.post.domain.exprience.QExperiencePost.experiencePost;
...
public class ExpRepo {
    ...
    public List<ExperienceListDto> findTop4OrderByIdDesc(){
        return em.createQuery("SELECT new farmeasy.server.post.dto.experience.(ep.id,ep.postLike,ep.title,a.address.sigungu,ep.cropCategory,a.farm.farmName,ep.recruitment.startTime) " +
